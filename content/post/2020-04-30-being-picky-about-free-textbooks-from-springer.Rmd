...
This part of the data wrangling required some trial and error to gauge how many columns I needed to completely seperate all sub-categories. From another round of `skim`, it looks like only 7 columns were needed because column `category8` is empty. I'll proceed to remove it followed by `pivot_longer()`.  
Some observations:
...
I created word clouds for the most popular categories in the event anyone is looking for some inspiration on topics to dive into.
