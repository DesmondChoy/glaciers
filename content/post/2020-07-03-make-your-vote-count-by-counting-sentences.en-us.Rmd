...
In the first and second quantile, the sentences contain random digits separated from sentences and short soundbites. In the remaining two quantiles we see more meaningful sentences discussing infant care centres, online gambling and national security that don't quite fall into any of the prior categories. There is a sentence addressing rising global temperatures that should be classified under `Climate Change`, but for the most part I think the search filters are good enough.   
