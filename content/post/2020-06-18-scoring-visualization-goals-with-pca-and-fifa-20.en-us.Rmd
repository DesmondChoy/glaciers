...
I note the [website](www.sofifa.com) where the data was scrapped from has its data updated once every few days. So there might be discrepancies if you're comparing the numbers in this data set to the latest ones featured on the website.  
...
data %>%
  ...
  labs(
    x = "",
    y = "",
    title = "Which Continents Have Highest # Of International Players With No Clubs/Contracts?",
    subtitle = "A higher percentage of players come from Africa, Americas and Europe.\nPerhaps these are countries with no well-established soccer league?",
    caption = "Source: FIFA 20 Complete Player Data Set"
  ) +
  theme(
    plot.title = element_text(face = "bold", size = 20),
...
data %>%
  ...
  labs(
    ...
    subtitle = "Ironically, the gap between overall and potential performance is even wider for players with club contracts, albeit with longer right tails.\nThis could also be due to a larger sample size.",
    caption = "Source: FIFA 20 Complete Player Data Set"
  ) +
  theme(
    plot.title = element_text(face = "bold", size = 20),
...
```{r Players With And Without Contracts}
labels <-
  c("D" = "Defender",
